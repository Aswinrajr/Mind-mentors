        ...
        <div className="relative mb-6">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <button
              ...
              className="group px-4 py-2 rounded-xl bg-[rgb(177,21,177)] text-white font-medium shadow-lg hover:shadow-xl transform transition-all duration-300 hover:-translate-y-1"
            >
        ...
        {kids?.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {kids.map((kid) => (
              ...
              >
                ...
                <div className="h-24 bg-gradient-to-r from-[rgb(177,21,177)] to-[rgb(147,21,177)] relative">
                ...
                <div className="px-4 pt-10 pb-4">
                  <div className="text-center mb-4">
                    ...
                    <div className="bg-gradient-to-r from-[rgb(177,21,177)] to-[rgb(147,21,177)] text-white rounded-full px-3 py-1 inline-block">
                  ...
                  {/* <button
                    ...
                    className="w-full bg-gradient-to-r from-[rgb(177,21,177)] to-[rgb(147,21,177)] hover:from-[rgb(157,21,177)] hover:to-[rgb(127,21,177)] text-white px-4 py-2 rounded-lg font-medium transition-all duration-300 shadow-md hover:shadow-lg flex items-center justify-center group text-sm"
                  >
                    <Calendar className="w-4 h-4 mr-1 group-hover:rotate-12 transition-transform" />
                    View Progress
          ...
          <div className="bg-white rounded-xl shadow-xl p-8 text-center max-w-2xl mx-auto">
            <div className="bg-purple-100 w-16 h-16 rounded-full mx-auto mb-6 flex items-center justify-center group hover:scale-110 transition-transform duration-300">
              <UserPlus className="w-8 h-8 text-purple-600 group-hover:rotate-12 transition-transform" />
            </div>
            ...
            <button
              onClick={() => navigate("/parent/add-kid")}
              className="inline-flex items-center px-6 py-3 rounded-lg bg-gradient-to-r from-[rgb(177,21,177)] to-[rgb(147,21,177)] hover:from-[rgb(157,21,177)] hover:to-[rgb(127,21,177)] text-white font-medium shadow-lg hover:shadow-xl transition-all duration-300 group"
            >
