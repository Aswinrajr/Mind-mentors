    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-8">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center mb-6">
          ...
          <h1 className="ml-4 text-2xl font-bold text-[#b115b1]">Demo Class</h1>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-9">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button type="button" onClick={handleAddProgram} className="flex items-center gap-2 text-[#b115b1] hover:text-opacity-80">
              <Plus size={20} />
              Add Another Program
            </button>
            ...
            <button
              type="submit"
              className="w-full py-3 bg-[#b115b1] text-white rounded-md hover:bg-opacity-90 transition-all disabled:opacity-50"
              disabled={loading}
            >
