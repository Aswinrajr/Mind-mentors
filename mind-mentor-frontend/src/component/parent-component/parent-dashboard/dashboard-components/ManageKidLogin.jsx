...
const ManageChildLogin = () => {
  ...
  return (
    <div className=" bg-gray-50 flex items-center justify-center mt-7">  {/* Centered the content without any margin-left */}
    <div
      className="w-full max-w-md bg-[#b115b1] rounded-xl shadow-lg 
    ...
    >
      <div className="p-8 text-center border-b border-gray-100">
        ...
        >
          <Lock className="w-8 h-8 text-[#b115b1] transition-transform duration-300 hover:rotate-12" />
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full py-3 bg-white text-[#b115b1] rounded-lg font-medium 
