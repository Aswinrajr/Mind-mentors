      ...
      <form className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            {/* Parent Email */}
            <div className="flex items-center space-x-4">
              <label className="w-36 text-sm font-medium text-gray-700">Parent's Email ID</label>
          ...
          <div className="space-y-6">
            {/* Kid's Name */}
            <div className="flex items-center space-x-4">
              <label className="w-36 text-sm font-medium text-gray-700">Kid's Name</label>
              <input
                type="text"
                placeholder="First Name"
                className="flex-1 p-2 border rounded text-sm focus:outline-none"
            ...
            {/* Kid's Age */}
            <div className="flex items-center space-x-4">
              <label className="w-36 text-sm font-medium text-gray-700">Kid's Age</label>
              <input
                type="number"
                placeholder="Age"
                className="w-full p-2 border rounded text-sm focus:outline-none"
            ...
            {/* Kid's Gender */}
            <div className="flex items-center space-x-4">
              <label className="w-36 text-sm font-medium text-gray-700">Kid's Gender</label>
              <select className="w-full p-2 border rounded text-sm focus:outline-none bg-white">
                <option value="">-Select-</option>
              </select>
            </div>
